    ...
    "paths": {
        ...
        "/api/v1/admin/users/{id}/tenant": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Dados de atribuição de tenant",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AssignTenantRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/clients": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dados do Cliente da Temporada",
                        "name": "client",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/photographers": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/photographer.Photographer"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dados do Fotógrafo",
                        "name": "photographer",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        "client.Dog": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "Generated by client or backend (e.g. uuid)",
                    "type": "string"
                },
                "is_owner": {
                    "type": "boolean"
